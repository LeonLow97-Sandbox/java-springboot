...
class ContactsApplicationTests {
	...
	private Contact[] contacts = new Contact[] {new Contact("1", "Jon Snow", "6135342524"),
	...
	// So the next integration test runs as a clean state
	@AfterEach
	void clear() {
	...
	public void validContactCreation() throws Exception {
		RequestBuilder request =
				MockMvcRequestBuilders.post("/contact").contentType(MediaType.APPLICATION_JSON)
