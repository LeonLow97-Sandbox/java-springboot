...
public class GradeServiceTest {
  ...
  public void addGradeTest() {
    ...
    verify(gradeRepository, times(1)).addGrade(newGrade); // method should be invoked once because Hermoine doesn't exist in the data store
  }
  ...
  public void updateGradeTest() {
    ...
    verify(gradeRepository, times(1)).updateGrade(grade, 0); // checking if this function gets called when we submit an existing grade
  }
